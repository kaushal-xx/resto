...
class UserOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_order" do
    assert_difference('UserOrder.count') do
      post user_orders_url, params: { user_order: { order_amount: @user_order.order_amount, order_date: @user_order.order_date, order_number: @user_order.order_number, table_booking_id: @user_order.table_booking_id, user_id: @user_order.user_id } }
    end
  ...
  test "should update user_order" do
    patch user_order_url(@user_order), params: { user_order: { order_amount: @user_order.order_amount, order_date: @user_order.order_date, order_number: @user_order.order_number, table_booking_id: @user_order.table_booking_id, user_id: @user_order.user_id } }
